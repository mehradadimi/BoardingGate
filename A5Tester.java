...
public class A5Tester {
	...
	public static void testInsertionAndRemoval() throws HeapFullException , HeapEmptyException {
		PriorityQueue pq = createNewPriorityQueue();
		...
		System.out.println("SIZE IS : " + pq.toString());
	...
	public static void stressTest() {
		...
		displayResults(testRandomArray(15000), "inserts + removes");
		displayResults(testRandomArray(25000), "inserts + removes");
